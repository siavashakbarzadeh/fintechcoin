    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <li class="dash-item dash-hasmenu
                                             ">
                <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-shopping-cart-plus"></i></span><span class="dash-mtext"><?php echo e(__('Manage Email')); ?></span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                <ul class="dash-submenu">

                    <li class="dash-item ">
                        <a class="dash-link" href="<?php echo e(route('email.index')); ?>"><?php echo e(__('Listed')); ?></a>
                    </li>


                    <li class="dash-item <?php echo e((request()->is('taskboard*') ? 'active' : '')); ?>">
                        <a class="dash-link" href="<?php echo e(route('email.send')); ?>"><?php echo e(__('Send')); ?></a>
                    </li>

                    <li class="dash-item <?php echo e((request()->is('taskboard*') ? 'active' : '')); ?>">
                        <a class="dash-link" href="<?php echo e(route('email.pending')); ?>"><?php echo e(__('pending')); ?></a>
                    </li>
                          ...
                          || Gate::check('ledger report') ||  Gate::check('trial balance report')  ): ?>
                            <li class="dash-item dash-hasmenu
                                    ...
                                    <?php endif; ?>
                                            ...
                                            <li class="dash-item ">
                                                <a class="dash-link" href="<?php echo e(route('resell.index')); ?>"><?php echo e(__('Resell')); ?></a>
                                            </li>
                    ...
                    <?php if(\Auth::user()->type!='super admin'): ?>
                        <div class="navbar-footer border-top ">
                            <div class="d-flex align-items-center py-3 px-3 border-bottom">
                                ...
                                <div>
                                    <b class="d-block f-w-700"><?php echo e(__('messaging')); ?></b>
...
<?php /**PATH C:\Users\Utente\Documents\GitHub\fintechcoin\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>
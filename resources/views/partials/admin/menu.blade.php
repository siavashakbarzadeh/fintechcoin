        ...
        <div class="navbar-content">
            <li class="dash-item dash-hasmenu">
                ...
                <ul class="dash-submenu">
                    ...
                    <li class="dash-item ">
                        <a class="dash-link" href="{{ route('email.index') }}">{{__('Listed')}}</a>
                    </li>


                    <li class="dash-item {{ (request()->is('taskboard*') ? 'active' : '')}}">
                        <a class="dash-link" href="{{ route('email.send') }}">{{__('Send')}}</a>
                    </li>

                    <li class="dash-item {{ (request()->is('taskboard*') ? 'active' : '')}}">
                        <a class="dash-link" href="{{ route('email.pending') }}">{{__('pending')}}</a>
                    </li>
                          ...
                          || Gate::check('ledger report') ||  Gate::check('trial balance report')  )
                            <li class="dash-item dash-hasmenu
                                    ...
                                    @endif
                                            ...
                                            <li class="dash-item ">
                                                <a class="dash-link" href="{{ route('resell.index') }}">{{__('Resell')}}</a>
                                            </li>
                    ...
                    @if(\Auth::user()->type!='super admin')
                        <div class="navbar-footer border-top ">
                            <div class="d-flex align-items-center py-3 px-3 border-bottom">
                                ...
                                <div>
                                    <b class="d-block f-w-700">{{__('messaging')}}</b>
